class ShowsController < ApplicationController
  ...
  private
    ...
    def show_params
      params.require(:show).permit(:venue_id, :artist_id, :showdate, :showtitle, :meta, :shownotes, :showyear, :showorder, :settype, :opener, :tour_id, :lastuser, :soundcheck, :permalink, :isverified)
    end
end
