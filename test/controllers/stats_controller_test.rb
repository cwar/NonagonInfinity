...
class StatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stat" do
    assert_difference("Stat.count") do
      post stats_url, params: { stat: { favorite_songs: @stat.favorite_songs, shows_attended: @stat.shows_attended, user_id: @stat.user_id } }
    end
  ...
  test "should update stat" do
    patch stat_url(@stat), params: { stat: { favorite_songs: @stat.favorite_songs, shows_attended: @stat.shows_attended, user_id: @stat.user_id } }
